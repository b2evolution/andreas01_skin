...
<img width="760" height="175" alt="" src="img/front.jpg" id="frontphoto"/>



<!-- =================================== START OF SIDEBAR =================================== -->
<div class="bSideBar" id="avmenu">

	<div class="blog_list"><ul>
		  <?php
		  // START OF BLOG LIST
		  skin_widget( array(
...
<div id="extras">
	<?php
		// ------------------------- "Sidebar" CONTAINER EMBEDDED HERE --------------------------
		// Display container contents:
		skin_container( NT_('Right Sidebar'), array(
				// The following (optional) params will be used as defaults for widgets included in this container:
				// This will enclose each widget in a block:
				'block_start' => '<div class="bSideItem $wi_class$">',
				'block_end' => '</div>',
...
<div id="footer">
	...
	<p class="baseline">
		...
		?>
		design by <a href="http://andreasviklund.com">Andreas Viklund</a> | evoskin by <a href="http://personman.com">Danny Ferguson</a>
		<br />
		<?php
